  ...
  return (
    <nav className="fixed inset-x-0 bottom-0 z-50 w-full px-3 sm:px-4 md:px-0 pb-[calc(0.75rem+env(safe-area-inset-bottom))] md:pb-[env(safe-area-inset-bottom)]">
      <div className="relative">
        ...
        >
          <span className="w-14 h-14 min-[360px]:w-16 min-[360px]:h-16 rounded-full bg-[#0D5C3A] text-white flex items-center justify-center border-4 border-white shadow-[0_8px_24px_rgba(13,92,58,0.35)]">
