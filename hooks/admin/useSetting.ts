...
// GET profil admin
export function useAdminProfile(options?: { onSuccess?: (data: AdminProfile) => void }) {
...
export function useWAConfig(options?: { onSuccess?: (data: WAConfig) => void }) {
...
export function useUpdateWAConfig(options?: { onSuccess?: (data: WAConfig) => void }) {
  const queryClient = useQueryClient();
...
export function useTestWAConnection() {
  return useMutation<void, Error, void>({
    mutationFn: () =>
      fetchAPI("/settings/whatsapp/test", { method: "POST" }),
  });
}
