...
const AdminLogin = () => {
  ...
  const handleLogin = (e: React.FormEvent) => {
    ...
    login.mutate(
      ...
      {
        onSuccess: (data) => {
          // token & role sudah disimpan di useAuth.ts onSuccess
          ...
          <h1 className="text-3xl font-bold flex items-center gap-3">
            <span className="inline-block w-12 h-12 bg-white/20 rounded-lg flex items-center justify-center">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 11c0-1.657-1.343-3-3-3s-3 1.343-3 3 1.343 3 3 3 3-1.343 3-3zm0 0v6m0 0h6m-6 0H6" />
              </svg>
            </span>
            Admin Panel
          </h1>
        ...
        <div>
          ...
          <ul className="space-y-4">
            {[
              ...
              <li key={i} className="flex items-start gap-4 bg-white/10 p-4 rounded-lg">
      ...
      <div className="w-1/2 flex items-center justify-center bg-white p-16">
        <div className="w-full max-w-md">
          ...
          <div className="text-center mb-8">
            ...
            <h2 className="text-2xl font-bold mt-4 text-gray-800">Login Admin</h2>
            <p className="text-gray-500 mt-1 text-sm">Assalamualaikum, Selamat Datang Kembali</p>
          </div>
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-9 pr-4 py-2.5 border border-gray-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-cyan-400 focus:border-transparent bg-gray-50"
                  required
                />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-9 pr-10 py-2.5 border border-gray-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-cyan-400 focus:border-transparent bg-gray-50"
                  required
                />
                <button
                  type="button"
            ...
            <div className="p-3 bg-green-50 rounded-xl border border-green-200 text-green-700 text-xs flex items-start gap-2">
              ...
              <span>
                <strong>Peringatan Keamanan:</strong> Pastikan Anda memiliki izin akses sebelum login.
                Setiap aktivitas admin akan tercatat dalam sistem log.
              </span>
            </div>
            ...
            <div className="text-center text-gray-500 text-sm">
              <p>atau</p>
              <Link href="/login" className="inline-block mt-1 text-cyan-500 hover:underline text-sm">
